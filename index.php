                    ...
                    <div class="row gx-5 align-items-center justify-content-center">
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                <h1 class="display-5 fw-bolder text-white mb-2">M.BOBBYZAL CENDANA ZE</h1>
                                <p class="lead fw-normal text-white-50 mb-4">Tulisan ini hanyalah untuk menambah estetika saja</p>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-10 col-xl-7">
                            <div class="text-center">
                                <div class="fs-4 mb-4 fst-italic">"Nobody can make you feel inferior without your permission."</div>
